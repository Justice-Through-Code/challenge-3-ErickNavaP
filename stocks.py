...
def stock_purchases():
    ...
    if stock_name == "Amazon" or stock_name == "amazon":
        ...
        stock = apple
    elif stock_name == "Facebook" or "facebook":
    ...
    print(f"{clientname} has ${dollars} to invest and can buy {stock_amount} shares of {stock_name} at the current price of ${stock}.")